...
document: ctexart
bibliography: E:/academic_resources/note-tutorial/data/format/MyLibrary.bib
csl: E:/academic_resources/note-tutorial/data/format/journal-of-ecology.csl
output: 
...
destfile <- "E:/academic_resources/note-tutorial/data/twitter_cit_data.csv"
download.file(url, destfile)
library(tidyverse)
#读取文件(注意搜寻到工作路径文件夹的下一级文件夹)并且把放入数据集citations_raw
citations_raw<-read_csv(file="E:/academic_resources/note-tutorial/data/twitter_cit_data.csv")
```
...
**注意：在csl、bibliography、css后面都是文件的名字，并且包含了其扩展名，而且这些文件要与rmd在同一文件夹下,如果不是要写明路径，例如csl与rmd文件不在同一个文件夹中，那么需要写`data/format/xxx.csl`（因为工作路径到ReproducibleScience为止）,另外冒号是英文形式，且一定要有个空格后再写具体规定是什么**
...
<br>
![](E:/academic_resources/note-tutorial/data/img/setup-chunk.png)
<br>
...
![](E:/academic_resources/note-tutorial/docs/figure/ReproScie-note.Rmd/exercise-2.png)
...
<br>
![](E:/academic_resources/note-tutorial/data/img/zotero-bib1.png)
<br>
<br>
![](E:/academic_resources/note-tutorial/data/img/zotero-bib2.png)
<br>
<br>
![](E:/academic_resources/note-tutorial/data/img/zotero-bib3.png)
<br>
...
<br>
<br>
![](E:/academic_resources/note-tutorial/data/img/zotero-csl2.png)
<br>
<br>
![](E:/academic_resources/note-tutorial/data/img/zotero-csl3.png)
<br>
<br>
...
library("citr")
md_cite("Cuny 2015", bib_file = "E:/academic_resources/note-tutorial/data/format/MyLibrary.bib")
```
...
```
getwd()
setwd("E:/academic_resources/note-tutorial/ReproducibleSicence/data/format")
getwd()
rmarkdown::draft(
...
```
4. 运行上述代码之后就会在note-tutorial/data/format文件中得到jss和rjournal的模板rmd文件，按找其中格式输入自己文章的文本内容和图片之后knit就会得到该期刊或出版社正确要求格式的文献的pdf和word格式，该包中提供的其他模板请参考[该链接](https://github.com/rstudio/rticles)
...
<br>
![](E:/academic_resources/note-tutorial/data/img/git1.png)
<br>
...
<br>
![](E:/academic_resources/note-tutorial/data/img/git2.png)
<br>
...
<br>
![](E:/academic_resources/note-tutorial/data/img/git4.png)
<br>

- 进入vi的模式之后按下键i进入文字编辑模式，编辑成如下是表示本地和远程仓库的内容都保留了,然后按键esc，在底部输入`:wq`后enter则保存该修改并且退出vi编辑器重新回到git bash模式
<br>
![](E:/academic_resources/note-tutorial/data/img/git5.png)
<br>

- 相较于用git bash进入vi模式编辑，更好的方式是使用vscode中的git，会出现如图所示的选择，第一个选择表示接受本地仓库的更改，第二个选择是接受远程仓库的更改，第三个选择是两个都接受，都接受的结果如第二张图片所示
<br>
![](E:/academic_resources/note-tutorial/data/img/git3.png)
<br>
<br>
![](E:/academic_resources/note-tutorial/data/img/git6.png)
<br>
...
<br>
![](E:/academic_resources/note-tutorial/data/img/git9.png)
<br>

- `git reflog`: 查看每次提交的版本是什么
<br>
![](E:/academic_resources/note-tutorial/data/img/git7.png)
<br>
...
<br>
![](E:/academic_resources/note-tutorial/data/img/git8.png)
<br>
...
- **关于—_site.yml文件内的内容可以看出规定网址的样式以及rmd格式的输出为html，可以自己进行更改，问题是如果analysis里的rmd文件有些是要输出slides模式的，那么应该删除output规定部分，只剩下以下代码部分，analysis内的其他各个形式的rmd的ymal部分自己规定(注意如果是输出其他格式由于yamal产生文件部分没有写workflowr会使得该文件不在Rproject管理下，因此其中所有路径都要写绝对路径而不是相对路径)，但是注意仍然是html格式输出时output的下面一行要写`workflowr::wflow_html:`而不是`html_document:`，否则的话所有代码运行产生的图片不会显示**
```
name: "note-tutorial"
output_dir: ../docs
navbar:
